...
public  class extendingThread extends Thread{
	...
	extendingThread(int empno,String empname,double empsalary){
		this.eno = empno;
		this.ename = empname;
	...
	public static void main(String[] args) {
		...
		extendingThread et1 = new extendingThread(101,"Faiz",1000.0);
		extendingThread et2 = new extendingThread(102,"Aman",2000.0);
		extendingThread et3 = new extendingThread(103,"Dp",3000.0);
		extendingThread et4 = new extendingThread(104,"Rupal",4000.0);
		extendingThread et5 = new extendingThread(105,"Mansi",5000.0);
